                ...
                {hasConversation ? (
                  ...
                  <Empty className="border-border bg-card/30">
                    <EmptyHeader>
                      ...
                      <EmptyTitle>Codex is ready for {targetLabels[activeTarget.id]}</EmptyTitle>
                      <EmptyDescription>
                        Use the center composer to inspect, edit, or compare code in this target.
                      </EmptyDescription>
                    </EmptyHeader>
                    <EmptyContent>
                      <Button
                ...
                <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        type="submit"
                        disabled={!prompt.trim() || isSending || sessionState.status === 'running'}
                      >
                        {isSending ? (
                          <LoaderCircleIcon className="animate-spin" data-icon="inline-start" />
                        ) : (
