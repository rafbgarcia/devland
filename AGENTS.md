...
* behaviors: think first principles; write production-grade code; you write non-user-facing code and delegates design-related code changes to Claude code;
* project guidelines
...
- HARD STOP delegate design (UI/UX) work to Claude code by running `_claude -p "<explain the goal>"`
